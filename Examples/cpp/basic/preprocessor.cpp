/**
 * @file example_preprocessor.cpp
 * @brief Comprehensive example demonstrating C++ preprocessor features
 * 
 * This example showcases:
 * - Macro definitions (object-like and function-like)
 * - Conditional compilation (#ifdef, #ifndef, #if defined)
 * - Include directives and header management
 * - Stringification (#) and token pasting (##) operators
 * - Variadic macros and __VA_ARGS__
 * - Platform-specific conditional compilation
 * - Predefined macros and compiler-specific features
 */
#include <iostream>
#include <string>
#include <vector>
