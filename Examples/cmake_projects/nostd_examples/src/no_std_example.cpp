...
// Demonstrates inheritance, templates, namespaces, control flow, expressions, etc.
...
int main() {
    ...
    ExampleNamespace::globalVar = 100;
    ExampleNamespace::namespaceFunction();
    ExampleNamespace::NamespaceClass nsObj(50);
