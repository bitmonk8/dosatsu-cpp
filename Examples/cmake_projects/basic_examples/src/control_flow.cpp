/**
 * @file example_control_flow.cpp
 * @brief Comprehensive example demonstrating C++ control flow constructs
 * 
 * This example showcases:
 * - Conditional statements (if/else, switch/case)
 * - Loop constructs (for, while, do-while, range-based for)
 * - Exception handling (try/catch/throw, RAII)
 * - Jump statements (break, continue, goto, return)
 * - Short-circuit evaluation and ternary operators
 * - Constexpr control flow for compile-time evaluation
 */
#include <iostream>
#include <vector>
#include <string>
...
// Example function that demonstrates all control flow patterns
void demonstrateControlFlow() {
    // Demonstrate simple conditions
    ...
    // Demonstrate conditional operators
    ...
    // Demonstrate constexpr (compile-time control flow)
