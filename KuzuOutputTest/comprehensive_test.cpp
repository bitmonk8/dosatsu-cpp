...
public:
    Duck(const char* n, int a) : WaterBird(n, a) {}
...
public:
    Penguin(const char* n, int a) : WaterBird(n, a) {}
...
namespace Mathematics {
    ...
    namespace Statistics {
        ...
        double standardDeviation(const double* values, size_t count) {
...
public:
    ExpressionTestClass(int v) : value(v), array(nullptr), size(0) {}
    ...
    ExpressionTestClass& operator++() { // Prefix
        ++value;
        return *this;
    }
    
    ExpressionTestClass operator++(int) { // Postfix
        ExpressionTestClass temp(*this);
        ++value;
        return temp;
    }
    ...
    // Pointer operations
    ExpressionTestClass* getThis() { return this; }
    ...
    const ExpressionTestClass* getAsConstPtr() const {
        return const_cast<const ExpressionTestClass*>(this);
    }
};
...
void testExpressions() {
    ...
    ExpressionTestClass result = obj1 + obj2;
    obj1 += obj2;
    ...
    ExpressionTestClass* ptr = obj1.getThis();
    ...
    const ExpressionTestClass* constPtr = obj1.getAsConstPtr();
}

void testMacros() {
    MacroTestClass obj(5.0);
