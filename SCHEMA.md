# Kuzu Database Schema for C++ AST Query

This document describes the graph database schema generated by MakeIndex when querying C++ codebases. The schema captures the Abstract Syntax Tree (AST) structure, type relationships, inheritance hierarchies, template specializations, and semantic relationships in C++ code.
